...
export default {
  ...
  created() {
    var that = this;
    var scaleresult = JSON.parse(localStorage.getItem("scaleresult"));
    that.detail = scaleresult;
    that.factors = scaleresult["result"];
    that.answers = scaleresult["answer"];
    console.log(that.factors, that.answers);
    var facname = [];
    var score = [];
