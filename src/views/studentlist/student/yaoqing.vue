  ...
  <div class="main">
    ...
    <div class="data">
      ...
      >
        ...
        <el-table-column property="a" label="日期"></el-table-column>
        <el-table-column property="b" label="星期"></el-table-column>
        ...
        <el-table-column label="操作">
          <template slot-scope="scope">
            <el-button size="mini" @click.stop="handleEdit(scope.$index, scope.row)">确认</el-button>
    ...
    <!-- <div class="add" @click="addnumber">我要预约</div> -->
...
export default {
  ...
  methods: {
    ...
    addnumber() {
      ...
      this.$router.push({ path: "/student/addyuyue" });
    },
    makesure() {
