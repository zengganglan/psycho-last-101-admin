  ...
  <div class="main">
    ...
    <div class="data">
      ...
      >
        ...
        <el-table-column property="b" label="作者"></el-table-column>
        <!-- <el-table-column property="c" label="时间"></el-table-column> -->
        <el-table-column property="f" label="评价对象"></el-table-column>
        <el-table-column property="f" label="评价类容"></el-table-column>
        <el-table-column property="f" label="类型"></el-table-column>        
    ...
    <div class="add" @click="addnumber">自我评价</div>
    <el-dialog title="自我评价" :visible.sync="dialogFormVisible">
      <el-form :model="form">
        ...
        <el-form-item label="自评内容" :label-width="formLabelWidth">
