      ...
      <li class="data1" v-if="tabindex==1">
        ...
        <table class="a1">
          ...
          <tr class>
            <td>工号：</td>
            <td>
              <input type="number" placeholder="工号" v-model="values.job_num" min='0'>
              <span>*</span>
            </td>
          </tr>
          <tr class>
          ...
          <tr class>
            ...
            <td>
              <div :style="{ 'text-align': 'center','width':'200px','vertical-align':'center'}">带*必填</div>
               <el-button type="primary" plain @click="newAdmin">增加</el-button>
               <el-button type="info" plain @click="returnback" style="margin-left:60px">返回</el-button>
