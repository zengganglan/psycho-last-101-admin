  ...
  <div class="main">
    ...
    <div class="data vrdata">
      ...
      width="55">
        ...
        <el-table-column  property="name"  label="序号"></el-table-column>
        <el-table-column property="unit_name" label="学校名称" ></el-table-column>
        <el-table-column property="unit_name" label="学校简介" ></el-table-column>
