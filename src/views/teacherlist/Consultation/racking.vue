<template>
 ...
 <el-table-column label="操作" width="160">
    ...
    <el-dialog title="个案追踪添加" :visible.sync="dialogFormVisible" >
      <el-form :model="form">
...
<el-select v-model="form.name" placeholder="请选择"  @change="changevalue" value-key>
    ...
    <el-dialog title="个案追踪编辑" :visible.sync="dialogFormVisible1">
      <el-form :model="form1">
...
export default {
  ...
  methods: {
    getlist(currentpage, pagesize) {
      ...
      var that = this;
      this.axios
        .post("/api/v1/admin/counsel/caseList", {
          page: currentpage,
          size: pagesize
        })
        .then(function(res) {
    ...
    handleEdit(index, row) {
      ...
      this.$router.push({path:"/Consultation/rackdetail",query:{id:row.id}})
    },
    editsure() {
      this.axios
