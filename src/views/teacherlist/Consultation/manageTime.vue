...
>
      ...
      <el-form :model="form">
        <ul>
          ...
          <li class="q q3" v-if="step==3">
            <el-form-item label="时间起（24小时制 时:分）" ><br/>
              <el-input
               placeholder="HH:mm"
              ...
              <el-card
                class="box-card"
                style="width: 210px; display:inline-block;position:absolute;top:-30px;right:10px;height:210px;overflow-Y: scroll"
              >
    ...
    <span >卡片名称</span>
            ...
            <el-form-item label="时间止  (24小时制 时:分)" ><br/>
              <el-input
                 placeholder="HH:mm"
...
export default {
  ...
  methods: {
    ...
    handleDelete(index, row) {
      ...
      var that = this;
      this.axios
        .post("/api/v1/admin/counsel/deleteTheme", { id: id })
        .then(function(res) {
          console.log(res);
          if (res["data"]["code"] == 0) {
            that.$message("删除成功");
