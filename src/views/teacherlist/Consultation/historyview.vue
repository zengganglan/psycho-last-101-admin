  ...
  <div class="main">
    ...
    <div class="data">
      ...
      >
        ...
        <el-table-column prop="staus" label="处理状态"></el-table-column>
        <el-table-column prop="proc_idea" label="处理意见"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    handleEdit(index, row) {
      ...
      this.$router.push({
        path: "/Consultation/historydetail",
