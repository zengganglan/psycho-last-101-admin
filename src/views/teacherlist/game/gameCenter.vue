  ...
  <div class="main">
    ...
    <div class="data vrdata">
      ...
      >
        ...
        <el-table-column property="last_upload_time" sortable label="最近上传"></el-table-column>
    ...
    <el-dialog title="团辅添加" :visible.sync="dialogFormVisible">
      <el-form :model="form">
    ...
    <el-dialog title="团辅编辑" :visible.sync="dialogFormVisible1">
      <el-form :model="form1">
        <el-form-item label="活动名称" :label-width="formLabelWidth">
...
export default {
  data() {
    return {
      ...
      // 头部组件信息
      headson: ["团辅活动数据",'点击某一行数据查询当前活动的excel文件列表'],
      tableData: [],
