      ...
      <div class="datas">
        ...
        >
          ...
          <el-table-column label="允许评论">
            <template slot-scope="scope">
              <span class="el-icon-check" v-if="scope.row.comment-0==1" style="color:green"></span>
              <span class="el-icon-close" v-else style="color:red"></span>
            </template>
          </el-table-column>
          <el-table-column prop="b" label="置顶">
            <template slot-scope="scope">
              <span class="el-icon-check" v-if="scope.row.topping-0==1" style="color:green"></span>
              <span class="el-icon-close" v-else style="color:red"></span>
            </template>
          </el-table-column>
  ...
  methods: {
    ...
    getEle() {
      ...
      if (!that.editor) {
        ...
        this.editor.customConfig.uploadImgServer = "/api/v1/admin/article/upload"; //上传URL
