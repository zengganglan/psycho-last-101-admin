          ...
          <template>
            <li>
              ...
              <div class="Regis">
                ...
                <el-select v-model="values.college_id" style="width:202px;" @change="selecrcs" placeholder="请和你老师的所属学校一致">
                  <el-option
...
export default {
  ...
  methods: {
    ...
    register() {
      ...
      // console.log(this.values.class.length);
       if (this.values.class) {
        var  unit= this.values.class[this.values.class.length-1]
       }
